...
Original file is located at
    https://colab.research.google.com/drive/1gIV4EVBWa8JKifQWDAJNlIsiNqgA9qFY
"""
...
# Frontend başka klasörden çalışacağı için CORS açıyoruz
app.add_middleware(
    CORSMiddleware,
    allow_origins=["*"],
...
async def predict(file: UploadFile = File(...)):
    ...
    # Ultralytics sonucu results/file_id klasörüne kaydeder
    result_folder = os.path.join(RESULT_DIR, file_id)
    result_image_path = os.path.join(result_folder, input_filename)

    return {
        "detections": detections,
        "result_image_url": f"http://127.0.0.1:8000/result/{file_id}/{input_filename}"
    }
